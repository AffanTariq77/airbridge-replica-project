...
export const AIEngineeringIcon = () => (
  // <svg viewBox="0 0 64 64" width={78.16} height={70} fill="none">
  //   <defs>
...
export const StaffAugmentationIcon = () => (
  <img
    src="/images/staff-augmentation.png"
    alt=""
    width={78.16}
    height={70}
  />
...
export const StrategicConsultingIcon = () => (
  <img
    src="/images/strategic_ai_consulting.png"
    alt=""
    width={78.16}
    height={70}
  />
